 ...
 */
public class ArmaColumnAssert extends AbstractColumnAssert<ArmaColumnAssert, Column<IInteractiveElement>> {

    /**
     * Creates a new <code>{@link ArmaColumnAssert}</code> to make assertions on actual ArmaElement.
     *
     * @param actual the ArmaElement we want to make assertions on.
     */
    public ArmaColumnAssert(Column<IInteractiveElement> actual) {
        super(actual, ArmaColumnAssert.class);
    }
     ...
     *
     * @param actual the ArmaElement we want to make assertions on.
     * @return a new <code>{@link ArmaColumnAssert}</code>
     */
    @CheckReturnValue
