...
public abstract class AbstractArmaContainerAssert<S extends AbstractArmaContainerAssert<S, A>, A extends ArmaContainer> extends AbstractObjectAssert<S, A> {
    ...
    public void assertAllElementsAreDisplayed(boolean shouldWait, Stream<IInteractiveElement> elementsStream) {
    ...
    public S containsValues(Map<String, String> expectedValues) {
        ...
        expectedValues.forEach((elementId, expectedValue) ->
                softAssertions.assertThat((ArmaElement) actual.getElement(elementId))
                        .value()
